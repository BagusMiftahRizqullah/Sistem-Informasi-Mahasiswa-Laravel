...
@section('judul','Form tambah data KRS' )
...
<div class="container">
    <div class="row">
        <div class="col-8">
        <h1 class="mt-3">Tambah Data KRS</h1>
       
                    <form method="POST" action="/krs/tambah">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nilai_huruf') is-invalid @enderror" id="nilai_huruf" placeholder="input nilai" name="nilai_huruf">
                        ...
                        <p>
                        <a href="/krs" class="badge badge-warning label">Kembali</a>
                        </p>                                                                   
                    </form>
